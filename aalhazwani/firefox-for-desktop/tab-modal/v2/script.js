...
function showModal() {
  // global variables
  var modal = document.getElementsByClassName("tab-modal")[0];
  var separator = document.getElementsByClassName("tab-modal-separator")[0];
  var content = document.getElementsByClassName("tab-modal-content")[0];
